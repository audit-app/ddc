...
async function generateMetadata({ params }) {
    ...
    const anuncio = (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$anuncios$2d$data$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getAnuncioById"])(id);
    if (!anuncio) {
        return {
...
function generateJsonLd(anuncio) {
    return {
